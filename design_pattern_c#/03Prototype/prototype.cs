/*
 copy the current object state and paste it new, without altering the previous state of that object

important -> copy() / clone() abstract method
 */


namespace design_pattern_c_._03Prototype
{
